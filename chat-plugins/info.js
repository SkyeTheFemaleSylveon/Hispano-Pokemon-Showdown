exports.commands = {
	...
	ligaph: function (target, room, user, connection) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('Toda la informacion de nuestra liga puede ser encontrada <a href="http://pokemon-hispano.comxa.com/showthread.php?tid=35" target="_BLANK">aquí­</a>.');
	},

        rule: 'reglas',
	reglas: function (target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('Por favor sigue las siguientes reglas:<br /><a href="http://pastebin.com/CSWuasXc" target="_blank">Reglas</a> en EspaÃ±ol<br /><a href="http://pastebin.com/eZ3dtX2c">Regras</a> em Portugues (<b>Gracias a Dlinkoto</b>)<br />');
	}
};
